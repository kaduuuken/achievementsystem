...
STATICFILES_DIRS = (
    ...
    path.join(PROJECT_PATH, 'achievements/static/'),
)
...
SECRET_KEY = '+-(oo*fo=np_%c#3*45#t$x01le8u9-@^l7&q8&^_w!&9mu$s='
...
ROOT_URLCONF = 'achievementTest.urls'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    path.join(PROJECT_PATH, 'achievementTest/templates/'),
)
